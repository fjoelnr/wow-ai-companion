...
function AICompanion.UI.Init()
  ...
  tipsFrame:SetClampedToScreen(true)
  ...
  local close = CreateFrame("Button", nil, tipsFrame)
  close:SetSize(24, 24)
  close:SetPoint("TOPRIGHT", -6, -6)
  local closeBg = close:CreateTexture(nil, "BACKGROUND")
  closeBg:SetAllPoints(close)
  closeBg:SetColorTexture(0.45, 0.12, 0.12, 0.95)
  local closeTxt = close:CreateFontString(nil, "OVERLAY", "GameFontNormal")
  ...
  close:SetScript("OnEnter", function()
    closeBg:SetColorTexture(0.65, 0.14, 0.14, 1)
  end)
  ...
  local closeBottom = CreateFrame("Button", nil, tipsFrame)
  closeBottom:SetSize(90, 22)
  closeBottom:SetPoint("BOTTOM", 0, 10)
  local closeBottomBg = closeBottom:CreateTexture(nil, "BACKGROUND")
  closeBottomBg:SetAllPoints(closeBottom)
  closeBottomBg:SetColorTexture(0.25, 0.25, 0.3, 0.9)
  local closeBottomTxt = closeBottom:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
  closeBottomTxt:SetPoint("CENTER")
  closeBottomTxt:SetText("Close")
